...
export default function Countdown() {
  ...
  return (
    <section className="relative min-h-screen sm:min-h-[120vh] md:min-h-[140vh] flex items-end justify-center py-16 sm:py-20 md:py-24 pb-20 sm:pb-24 md:pb-32 overflow-hidden">
      {/* Background Image */}
